...
clang-cl %sourcefilename%.c src\dbjsyslog_client_inner.c /nologo /MDd /D_DEBUG /Zi /TC /W3 /Fo%build%\ /Fe%build%\%sourcebasename%.dll /link /dll /def:%sourcefilename%.def
